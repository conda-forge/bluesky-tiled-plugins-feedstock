About bluesky-tiled-plugins-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/bluesky-tiled-plugins-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/bluesky-tiled-plugins-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install bluesky-tiled-plugins
```
...
It is possible to list all of the versions of `bluesky-tiled-plugins` available on your platform:
...
```
pixi search bluesky-tiled-plugins --channel conda-forge
```
